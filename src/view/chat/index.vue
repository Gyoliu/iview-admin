        ...
        <ul>
          <li v-for="item in records" :key='item'>
            <div v-if="item.type == 1">
              <div class="xw-chat-time">{{item.time}}</div>
              <div class="xw-chat-servicer">
                ...
                <div class="xw-chat-msg">
                  <span v-html="replaceFace(item.content)"></span>
                </div>
              </div>
            </div>
          ...
          <div class="xw-chat-tool-item">
            ...
            <transition name="fade">
              <div class="xw-window-text" v-if="showMoreOpratin">
                <label for="uploadImg">
                 <span><input type="file" name="image"  accept="image/*"  multiple style="display:none;" id="uploadImg">图片</span>
                </label>
